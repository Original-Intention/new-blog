...
public class ArticleController {
    ...
    public ModelAndView articleType(HttpServletRequest request){
        ...
        if(keywords==null||"".equals(keywords)){
            ...
            //传入分类时，按分类查询
            articles = articleService.selectByKeywords(keywords);
        }
        ModelAndView modelAndView=new ModelAndView("/admin/article_classify");
